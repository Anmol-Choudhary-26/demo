...
export default function LittleMoreFranchiseForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setDataToLocalStorage("FranchiseDetails2", JSON.stringify(formData));
    router.push("/auth/franchise/finance"); // Navigate to the next page
  };
      ...
      <div className="max-w-2xl w-full space-y-8">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-extrabold">
            A little more About your Franchise
          </h2>
          <p
